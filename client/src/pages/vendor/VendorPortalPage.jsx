    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-teal-700 rounded-2xl p-6 sm:p-8 text-white shadow-lg mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-emerald-100 text-sm mt-1">
              Manage your product catalog, update stock, and list new products.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
            <div className="text-gray-500 text-xs font-medium uppercase tracking-wider">Seller Status</div>
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl relative animate-in fade-in zoom-in-95 duration-200">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Add Product to Store</h3>
